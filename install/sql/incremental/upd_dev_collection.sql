...
ALTER TABLE `client` ADD `limit_access_mail_custom_rules` ENUM('n','y') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'y' AFTER `limit_access_mail_filter`;
ALTER TABLE `client` ADD `limit_access_mail_backup` ENUM('n','y') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'y' AFTER `limit_access_mail_custom_rules`;
